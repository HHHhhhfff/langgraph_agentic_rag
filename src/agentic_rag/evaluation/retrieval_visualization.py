...
def _render_hit_card(stage: str, snapshot: dict[str, Any], hit: dict[str, Any]) -> str:
    ...
    fields = {
        ...
        "bbox_items": len(metadata.get("bbox_items") or []) if isinstance(metadata.get("bbox_items"), list) else None,
        "page_spans": len(metadata.get("page_spans") or []) if isinstance(metadata.get("page_spans"), list) else None,
        "bbox_by_page": sorted((metadata.get("bbox_by_page") or {}).keys())
        if isinstance(metadata.get("bbox_by_page"), dict)
        else None,
        "bbox_system": metadata.get("bbox_coordinate_system"),
        "bbox_source": metadata.get("bbox_source"),
        "bbox_policy": metadata.get("bbox_merge_policy"),
        ...
        "expansion_mode": metadata.get("retrieval_expansion_mode"),
        ...
        "retry_carry_forward": metadata.get("retry_carry_forward"),
        "retry_carry_forward_added": metadata.get("retry_carry_forward_added"),
        "retry_carry_forward_matched": metadata.get("retry_carry_forward_matched"),
        "retry_carry_forward_replaced_current": metadata.get("retry_carry_forward_replaced_current"),
        "retry_carry_forward_replaced_current_score": _fmt_score(metadata.get("retry_carry_forward_replaced_current_score")),
        "retry_carry_forward_from_stage": metadata.get("retry_carry_forward_from_stage"),
        "retry_carry_forward_previous_rank": metadata.get("retry_carry_forward_previous_rank"),
        "retry_carry_forward_score": _fmt_score(metadata.get("retry_carry_forward_score")),
        "agent_relevance_score": _fmt_score(metadata.get("agent_relevance_score")),
        "agent_relevance_label": metadata.get("agent_relevance_label"),
        "agent_relevance_source": metadata.get("agent_relevance_source"),
        "agent_relevance_cache_hit": metadata.get("agent_relevance_cache_hit"),
        "agent_grade_cache_key": metadata.get("agent_grade_cache_key"),
        "agent_relevance_keep": metadata.get("agent_relevance_keep"),
        "agent_relevance_drop": metadata.get("agent_relevance_drop"),
        "agent_relevance_drop_cached": metadata.get("agent_relevance_drop_cached"),
