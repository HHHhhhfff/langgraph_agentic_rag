...
def format_taskgraph_debug(debug: dict[str, Any], *, max_items: int = 6) -> list[str]:
    ...
    lines = [
        ...
        f"- evidence_gate_enabled={_format_bool(debug.get('evidence_gate_enabled', True))}",
        f"- evidence_gate_skipped={_format_bool(debug.get('evidence_gate_skipped', False))}",
        f"- local_retry_enabled={_format_bool(debug.get('local_retry_enabled', True))}",
        f"- local_retry_skipped={_format_bool(debug.get('local_retry_skipped', False))}",
