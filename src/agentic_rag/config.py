...
class Settings(BaseSettings):
    ...
    rerank_guardrail_min_anchor_score: float = Field(default=0.30, description="Min prior score for rerank anchor protection")
    rerank_guardrail_require_strong_anchor: bool = Field(default=True, description="Only mark strong exact-anchor hits for rerank guardrail")
