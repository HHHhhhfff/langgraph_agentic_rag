...
def _flatten_serialized_hit(row: dict[str, Any]) -> dict[str, Any]:
    ...
    for key in (
        ...
        "agent_relevance_source",
        "agent_relevance_cache_hit",
        ...
        "rerank_selection_source",
        "rerank_guardrail_candidate",
        "rerank_guardrail_protected",
        "rerank_guardrail_reason",
        "rerank_guardrail_input_rank",
